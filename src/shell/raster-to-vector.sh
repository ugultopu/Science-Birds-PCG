...
python3 ../python/denoise_image.py "$black_and_white_base_name.$extension" "$denoised_base_name.$extension"
mogrify -format bmp "$denoised_base_name.$extension"
potrace -b svg "$denoised_base_name.bmp"
python3 ../python/svg_path_to_polygon.py "$denoised_base_name.svg"
